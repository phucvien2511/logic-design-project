...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=uart/uart.c main.c button_matrix/button.c interrupt/interrupt.c timer/timer.c lcd/lcd.c i2c/i2c.c adc/adc.c pwm/pwm.c "../PICKITMPLAB/He Thong Nhung - VDK 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c"

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/uart/uart.o ${OBJECTDIR}/main.o ${OBJECTDIR}/button_matrix/button.o ${OBJECTDIR}/interrupt/interrupt.o ${OBJECTDIR}/timer/timer.o ${OBJECTDIR}/lcd/lcd.o ${OBJECTDIR}/i2c/i2c.o ${OBJECTDIR}/adc/adc.o ${OBJECTDIR}/pwm/pwm.o ${OBJECTDIR}/_ext/696230594/simulate_machine.o
POSSIBLE_DEPFILES=${OBJECTDIR}/uart/uart.o.d ${OBJECTDIR}/main.o.d ${OBJECTDIR}/button_matrix/button.o.d ${OBJECTDIR}/interrupt/interrupt.o.d ${OBJECTDIR}/timer/timer.o.d ${OBJECTDIR}/lcd/lcd.o.d ${OBJECTDIR}/i2c/i2c.o.d ${OBJECTDIR}/adc/adc.o.d ${OBJECTDIR}/pwm/pwm.o.d ${OBJECTDIR}/_ext/696230594/simulate_machine.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/uart/uart.o ${OBJECTDIR}/main.o ${OBJECTDIR}/button_matrix/button.o ${OBJECTDIR}/interrupt/interrupt.o ${OBJECTDIR}/timer/timer.o ${OBJECTDIR}/lcd/lcd.o ${OBJECTDIR}/i2c/i2c.o ${OBJECTDIR}/adc/adc.o ${OBJECTDIR}/pwm/pwm.o ${OBJECTDIR}/_ext/696230594/simulate_machine.o

# Source Files
SOURCEFILES=uart/uart.c main.c button_matrix/button.c interrupt/interrupt.c timer/timer.c lcd/lcd.c i2c/i2c.c adc/adc.c pwm/pwm.c ../PICKITMPLAB/He Thong Nhung - VDK 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/_ext/696230594/simulate_machine.o: ../PICKITMPLAB/He\ Thong\ Nhung\ -\ VDK\ 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/_ext/696230594" 
	@${RM} ${OBJECTDIR}/_ext/696230594/simulate_machine.o.d 
	@${RM} ${OBJECTDIR}/_ext/696230594/simulate_machine.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1 -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/696230594/simulate_machine.o   "../PICKITMPLAB/He Thong Nhung - VDK 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c" 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/696230594/simulate_machine.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/696230594/simulate_machine.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
${OBJECTDIR}/_ext/696230594/simulate_machine.o: ../PICKITMPLAB/He\ Thong\ Nhung\ -\ VDK\ 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/_ext/696230594/simulate_machine.o.d 
	@${RM} ${OBJECTDIR}/_ext/696230594/simulate_machine.o 
	${MP_CC} $(MP_EXTRA_CC_PRE) -p$(MP_PROCESSOR_OPTION) -ms -oa-  -I ${MP_CC_DIR}\\..\\h  -fo ${OBJECTDIR}/_ext/696230594/simulate_machine.o   "../PICKITMPLAB/He Thong Nhung - VDK 9/Bai9_TRAFFIC_UART/simulate_machine/simulate_machine.c" 
	@${DEP_GEN} -d ${OBJECTDIR}/_ext/696230594/simulate_machine.o 
	@${FIXDEPS} "${OBJECTDIR}/_ext/696230594/simulate_machine.o.d" $(SILENT) -rsi ${MP_CC_DIR}../ -c18 
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w -x -u_DEBUG -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -z__MPLAB_DEBUG=1 -z__MPLAB_DEBUGGER_PICKIT2=1 $(MP_LINKER_DEBUG_OPTION) -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
else
dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_LD} $(MP_EXTRA_LD_PRE)   -p$(MP_PROCESSOR_OPTION_LD)  -w  -m"${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"  -z__MPLAB_BUILD=1  -u_CRUNTIME -l ${MP_CC_DIR}\\..\\lib  -o dist/${CND_CONF}/${IMAGE_TYPE}/Traffic-Light.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}   
endif
